...
export default function Hero() {
    return (
        <section className="hero p-4 mt-10">
            <div className="py-8">
                <h1 className="text-4xl text-primary font-normal capitalize">Everything is better with a <span className="text-secondary font-extrabold">pizza</span></h1>
                <p className="my-4 text-primary capitalize">
                ...
                <div className="flex gap-2 my-4 items-center">
                    <button className="uppercase bg-secondary rounded-full px-10 py-3  text-dark flex items-center group relative overflow-hidden">
                        <span className="absolute inset-y-0 left-0 flex items-center pl-3 transform transition-transform duration-1000 group-hover:translate-x-32 group-hover:text-primary ">
                            <SolidIcon className="h-6 w-6" />
                        </span>
                        <span className="relative text-nowrap group-hover:text-acc">Order Now</span>
                    </button>
                    <button className="font-bold flex items-center gap-1 group text-gray-500">
